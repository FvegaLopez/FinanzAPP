  ...
  try {
    ...
    if (body.object === 'whatsapp_business_account') {
      ...
      if (messages && messages.length > 0) {
        ...
        // Extraer texto del mensaje (texto normal o respuesta de botón/lista)
        ...
        if (state && state.type === 'awaiting_account_selection') {
          ...
          // Buscar cuenta por número (1, 2, 3) o por nombre del botón
          ...
          if (!isNaN(accountIndex) && accountIndex >= 0 && accountIndex < accounts.length) {
            ...
            // Intentar por nombre parcial del botón (ej: "1. Efectivo" -> buscar "Efectivo")
        ...
        switch (intention) {
          ...
          case 'transaction':
            ...
            if (detectedAccount) {
              ...
              // Múltiples cuentas → usar botones o lista según cantidad
